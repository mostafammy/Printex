> **Canonical copy — owned jointly with 015; keep in sync.** Verbatim copy of
> `specs/015-collection-delivery/contracts/aspects.md`, included so 016 is self-contained if it
> merges first. Do not edit here alone: any change must be made in both files and every consumer
> feature notified (§ Status below).
